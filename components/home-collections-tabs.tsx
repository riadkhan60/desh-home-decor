...
function ProductPrice({ product }: { product: ProductCard }) {
  if (product.hasMultipleVariants && product.priceMin && product.priceMax) {
    return (
...
export function HomeCollectionsTabs({ collections }: HomeCollectionsTabsProps) {
