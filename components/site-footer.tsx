        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1 text-sm">
              <a
                href="tel:01703119775"
                className="block text-muted-foreground transition hover:text-[#D4AF37]"
              >
                01703-119775
              </a>
              <a
                href="https://wa.me/8801703119775"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-muted-foreground transition hover:text-[#25D366]"
              >
                <svg
                  className="h-4 w-4"
                  fill="currentColor"
            ...
            <div className="flex gap-4">
              <Link
                href="https://www.facebook.com/deshihomedecor"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground transition hover:text-[#1877F2]"
                aria-label="Facebook"
              >
                <svg
                  className="h-5 w-5"
              ...
              <Link
                href="https://www.instagram.com/deshihomedecor"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground transition hover:text-[#E4405F]"
              ...
              <Link
                href="https://www.tiktok.com/@deshihomedecor"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground transition hover:text-[#00F2EA]"
                aria-label="TikTok"
              >
                <svg
                  className="h-5 w-5"
