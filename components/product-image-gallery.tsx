    ...
    <>
      <div className="space-y-4">
        ...
        <button
          ...
          className="relative aspect-square w-full overflow-hidden rounded-2xl bg-linear-to-br from-zinc-800 to-black transition hover:opacity-95"
        >
          <Image
          ...
          {displayImages.map((image, index) => (
            <button
              ...
              className={`relative aspect-square overflow-hidden rounded-lg border-2 transition ${
                index === selectedIndex
                  ? "border-linear-to-br from-[#D4AF37] to-[#D4AF37]/60"
